...
<div id="p_config_gestion" class="container">
	<div class="row">
		<ul id="menu_p_config" class="nav nav-pills nav-stacked span2">
			<li id="lien1" ><a href="p_config_gestion.php">Utilisateurs</a></li> 
			<li id="lien2" class="active"><a href="p_config_gestion2.php">Groupes</a></li>
		</ul>
		<div id="contenu_p_config_gestion" class="span10">
			<?php 
				include 'configuration/gestion/gestion_groupes.php';
			?>
		</div>
	</div>
