-- SQL Dump
--
-- Generation: Tue, 13 May 2014 22:19:40 +0200
...
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8 COMMENT='Table activité générique' ;
...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='Table activité terrain' ;
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='Table collaborateurs' ;
...
('1', 'toto', 'tata', '2014-05-01', 'azerty', 'Informatique', 'homme', '06.01.23.45.56', '8 cours albert thomas', '69000', 'Lyon', 'toto.tata@ass.com');
...
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COMMENT='Table compétence' ;
...
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8 COMMENT='Table emploi' ;

--
-- Table data: `Emploi`
--
INSERT INTO `Emploi` (`id_emploi`, `lib_emploi`, `descr_emploi`) VALUES 
('2', 'azerryt', 'azeazezaeaze'),
('3', 'dfsfdsdf', 'blablbabla'),
('5', 'test', 'test'),
...
) ENGINE=InnoDB AUTO_INCREMENT=23795 DEFAULT CHARSET=utf8 ;
...
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8 COMMENT='Table portefeuille' ;
...
('20', 'retest', 'efff', '0'),
('21', 'retest', 'efff', '0'),
('22', 'Jardinier', 'Entretien des pelouses', 'o'),
('23', 'comp1', 'desc1', 'a'),
('24', 'comp2', 'desc2', 'b'),
('25', 'comp3', 'desc3', 'c'),
('26', 'comp4', 'desc4', 'd'),
...
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='Table profil de poste' ;
...
('10', 'vmp', 'c0ffef9b7eef64fc9a6f35324211cf61da7a2415', 'Pion', 'Vlad', 'vmp@hr-profiler.com', '1'),
('11', 'lolo', 'a7ca81c17d0ab3e5c2d7dbe755b30aea799d7b1e', 'M', 'lolo', 'lolo@lolilol.fr', '1');